    ...
    <section class="our_speciality_area section_padding_200" data-stellar-background-ratio="0.6" id="plus">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4">
                            <div class="single_speciality">
                                ...
                                <div class="single_speciality_text">
                                    <h5>Automatizarea sarcinilor</h5>
                                </div>
                            </div>
                        </div>
                        <!-- Single Speciality Area Start -->
                        ...
                        <div class="col-xs-12 col-sm-4">
                            <div class="single_speciality">
                                ...
                                <div class="single_speciality_text">
                                    <h5>Realizeaza sarcini complexe</h5>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-4">
                            <div class="single_speciality">
                                ...
                                <div class="single_speciality_text">
                                    <h5>Necesita baze mari de date</h5>
                                </div>
                            </div>
                        </div>
                        <!-- Single Speciality Area Start -->
                        <div class="col-xs-12 col-sm-4">
                            <div class="single_speciality">
                                ...
                                <div class="single_speciality_text">
                                    <h5>Se bazeaza pe interpretari</h5>
                                </div>
                            </div>
                        </div>
                        <!-- Single Speciality Area Start -->
